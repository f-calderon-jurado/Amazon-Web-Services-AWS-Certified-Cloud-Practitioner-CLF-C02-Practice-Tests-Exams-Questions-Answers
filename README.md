...
- [x] They are connected to each other through low-latency links.
- [x] They are fault tolerant.

### Which of the following is NOT 1 of the 3 main models for cloud computing?
- [ ] Software as a Service
- [x] Access as a Service
...
- [x] Edge locations can cache data for your users.
...
- [x] It allows on-demand spinning up of needed resources (such as virtual machines).
- [ ] It uses fixed-rate pricing for available services.
- [x] It offers easy access to servers, storage, and other services over the internet.
...
- [x] Services are delivered via the internet.
...
- [x] Durability offers long-term data protection.
...
- [x] Standard queues provide a loose-FIFO capability.
...
- [x] Amazon Elastic Block Storage (EBS)
...
- [x] Amazon Simple Email Service (SES)
...
- [x] It is a collection of services designed to monitor and observe cloud resources.
...
- [x] Lambda is recommended for processes that run for at least 15 minutes.
...
- [x] Amazon Route 53 is a dedicated physical network connection from your on-premises data center to AWS.
...
- [x] Enable multi-factor authentication (MFA) for administrative accounts as well as the root user.
...
- [x] The Cost Optimization pillar enables the ability to run systems to deliver business value at the lowest price point by utilizing a capital expenditures (CAPEX) model.
...
- [x] Patching the guest operating system (OS)
- [x] Firewall configuration and application security
...
- [x] Operational excellence pillar
- [x] Cost optimization pillar
- [x] Security pillar

### Which of the following are tasks that only the root user can complete? Choose 2

- [ ] Configure databases.
- [x] Close your AWS account.
- [x] Change the account name and email address.
...
- [x] Setting permissions for objects stored in Amazon S3
- [x] Amazon Elastic Block Store (EBS) snapshots
- [ ] AWS Lambda language versions
- [x] Amazon Relational Database Service (RDS) database backups

### Which service protects your web application from cross-site scripting attacks?

- [ ] Amazon Macie
- [x] AWS Web Application Firewall (WAF)
- [ ] Amazon Inspector
- [ ] AWS Shield
...
- [x] Its purpose is to enable you to easily generate and use your own encryption keys.
...
- [x] Open a service limit increase support case via email.
...
- [x] 1 million AWS Lambda requests per month
...
- [x] Service limit increases
- [x] Account and billing
...
- [x] Service limit checks
- [ ] AWS CloudTrail service down
- [x] Amazon S3 bucket permissions
- [x] Security Groups - Specific Ports Unrestricted
...
- [x] Deploy the application to multiple Regions.
...
- [x] Deploy the application to span across multiple Availability Zones (AZs).
- [ ] CloudFront
- [x] Utilize a multi-Region deployment when deploying the application.
...
- [x] Configure the load balancer to distribute incoming traffic across your registered targets in multiple Availability Zones
...
- [x] Use an Auto Scaling group to scale out and in based on demand.
...
- [x] Ability to focus on building the application instead of managing servers
- [ ] By default, AWS provides automatic distribution of applications across Regions for higher availability
- [x] Ability to grow and shrink computing capacity based on demand
- [ ] Automatic Multi-AZ deployment of databases to enhance availability
- [x] Ability to pay-as-you-go without upfront contracts or long-term commitments
...
- [x] Lower pay-as-you-go prices due to massive economies of scale.
...
- [x] AWS is responsible for the configuration of infrastructure devices.
...
- [x] Deploy smaller, reversible changes.
...
- [x] The customer is responsible for patching the guest operating system.
...
- [x] Use an instance profile to pass an IAM role with Amazon S3 permissions to the EC2 instance
...
- [x] Managing the Lambda runtime environment
...
- [x] Granting the minimum requirement to perform a task
...
- [x] Create individual users instead of using root.
- [ ] Grant users full access to just the services they need.
- [x] Enable MFA for privileged users
...
- [x] By default, all subnets within a VPC can communicate with each other.
...
- [x] By adding or removing EC2 instances from your EC2 fleet based on conditions you specify
...
- [x] No - by default, buckets and their contents are private
...
- [x] Utilize loosely coupled components
- [ ] Build monolithic systems
- [x] Design the architecture to reduce inter-dependencies
...
- [ ] The internet
- [x] Public subnets in the same VPC
- [x] Other private subnets in the same VPC
...
- [x] In multiple Availability Zones within the Region you select
...
- [ ] Software development
- [x] Hardware and infrastructure
- [x] Software license costs
- [x] Data center cooling, power, and space requirements

### You have upgraded your AWS Support plan to the Business Support level. What is true of the Business Support plan?

- [x] < 1 hour response time support when your production system goes down.
...
- [x] Contact the Support Concierge team.
- [ ] Technical Account Manager (TAM)
- [ ] AWS Online Tech Talks
- [x] Use the AWS Support API to programmatically open a case with AWS Support.
...
- [x] The company can use the AWS Pricing Calculator.
...
- [x] The developer is probably in a different Region from where the resources were initially deployed.
...
- [x] AWS maintains the underlying OS and performs software patching on the database.
...
- [x] Operate production workloads that are more highly available, fault tolerant, and scalable.
- [x] Provision exactly the right type and size of computing resources you need.
...
- [x] Deploy in multiple Availability Zones.
...
- [x] Benefit from increased speed and agility.
...
- [x] Low utilization on EC2 instances
- [ ] Upcoming user interface changes to the console
- [ ] Amazon services down
- [x] Open-access permissions for S3 buckets
- [x] Exposed access keys
...
- [x] The customer is responsible for managing access to the database.
- [ ] AWS is responsible for updating the database software.
- [ ] AWS is responsible for updating the guest operating system.
- [x] The customer is responsible for updating the guest operating system.
- [x] The customer is responsible for updating the database software.
...
- [x] Assign only the least privilege required.
...
- [x] Use multi-region deployments.
- [x] Use a serverless architecture first.
...
- [x] Managing the AWS global infrastructure
- [x] Protecting the data center infrastructure
- [ ] Managing network traffic
- [x] Maintaining networking components
...
- [x] Customers are responsible for security "in" the cloud.
...
- [x] AWS manages the hardware and AWS Global Infrastructure.
...
- [x] Activate MFA on the root account
...
- [x] Apply an IAM password policy to ensure users create appropriately strong passwords.

### The root user has full access to everything in the AWS account. Choose 2

- [x] The root user should be disabled after you create an admin user.
- [ ] The root user is the recommended way to work in the AWS Console.
- [x] The root user should not be used for day-to-day activities.
...
- [x] Submit a service limit increase.
...
- [x] DynamoDB is a NoSQL database.
...
- [x] Oracle to Amazon Aurora PostgreSQL
- [ ] MySQL to Amazon Aurora MySQL
- [x] Microsoft SQL Server to Amazon Aurora PostgreSQL
...
- [x] Lower latency for customers of your e-commerce website
- [ ] Advanced analytics into customer journeys
- [x] Protection against network and application layer attacks via WAF
- [ ] A scalable managed database that integrates seamlessly with Lambda and EC2
- [x] Increased application availability
...
- [x] They can reduce costs by sharing resources across accounts.
...
- [x] They can easily add new accounts or create new accounts.
- [x] They can receive 1 bill for all their AWS accounts.
...
- [x] Consulting partner from the AWS Partner Network (APN)
- [ ] Marketplace
- [ ] AWS Support
...
- [x] Replace upfront capital expenses with low variable costs.
...
- [x] Upgrade to the Enterprise plan.
...
- [ ] Amazon S3
- [x] S3 Glacier Flexible Retrieval (formerly S3 Glacier)
- [ ] Amazon EFS
...
- [x] Open a technical support case via email.
...
- [x] Use AWS Organizations and its consolidated billing feature to consolidate billing and payment for multiple AWS accounts.
...
- [x] Each AWS Region consists of multiple, isolated, and physically separate AZs within a geographic area.
- [ ] Edge locations contain Regions.
...
- [x] There are more Availability Zones than Regions
...
- [x] They contain only the resources and services specifically deployed to them.
- [x] They are grouped in geographic locations.
- [x] They are fully independent and isolated.
...
- [x] Customer Service Policy for Penetration Testing
...
- [x] Recover from failure automatically
...
- [x] Create an Organizational Unit structure in AWS Organizations with separate underlying accounts for production, development, and testing environments.
...
- [x] Create policies for each department that define the permissions needed. Create an IAM group for each department and attach the policy to each group. Add each department's members to their respective IAM group.
...
- [x] Have the user request temporary security credentials for the application by assuming a role
...
- [x] By assigning users to an IAM group that has the needed permissions.

### When talking about AWS security, what does "authentication" refer to?

- [x] Identifying who is accessing the system
...
- [x] Evaluating what permissions a user has
- [ ] A user delegating access to another user temporarily
...
- [x] Taking database backups
- [ ] Managing infrastructure security in RDS
- [x] Creating and managing database users
- [x] Collecting monitoring data to debug failures
- [x] Using AWS encryption solutions to protect data
...
- [x] Install the MySQL database directly on an EC2 instance.
...
- [x] Standard Reserved Instance (RI) with a capacity reservation
- [x] On-demand capacity reservation
- [x] Convertible Reserved Instance (RI) with a capacity reservation
...
- [x] When you require scalable capacity to maintain service levels in your environment
...
- [x] Use groups to delegate access to IAM users.
- [x] Activate Multi-factor Authentication (MFA) on your root account.
- [x] Create individual IAM users.
...
- [x] By using consolidated billing with AWS Organizations
...
- [x] 10 hours, 3 minutes, and 7 seconds
- [ ] 10 hours, 3 minutes
- [ ] 10 hours
- [ ] 10 hours, 4 minutes
...
- [x] Use consolidated billing in AWS Organizations.
...
- [x] By replacing large capital expenditures with lower variable costs spread over time
...
- [x] Hosting a content delivery network called CloudFront
...
- [x] Resizing an RDS instance type from db.r5.large to db.r5.2xlarge
- [ ] Adding 2 more EC2 instances
- [x] Resizing an EC2 instance type from a1.medium to a1.xlarge for more CPU and memory power
...
- [x] Removing "Block Public Access" from the bucket.
...
- [x] Changing the email address associated with the account
- [ ] Modifying the support plan
- [ ] Create a user with administrative access
- [x] Configuring an Amazon S3 bucket to enable MFA (multi-factor authentication)
- [x] Activate IAM access to the Billing and Cost Management console
...
- [x] Create multi-factor authentication for the root account.
- [x] Add IP restrictions for all accounts.
...
- [x] Who has access to the S3 service
...
- [x] Who has access to data you stored on the S3 service
...
- [x] Assign the instance an IAM role
...
- [x] Amazon Virtual Private Cloud infrastructure
- [ ] Subnets
- [ ] Network access control lists
- [ ] Security groups
- [x] Elastic Cloud Compute (EC2) infrastructure
...
- [x] Implement cloud financial management.
- [x] Utilize consumption-based pricing.
...
- [x] Internet data transfer
- [x] Running duration of the RDS instances
...
- [x] Reserved Instances act as a discount on new or existing On-Demand Instances.
- [x] Reserved Instances are available in all up-front, partial up-front, or no upfront payments.
- [x] Reserved Instances usually have contract terms of one or three years. The longer the term, the higher the savings.
...
- [x] Suggest that the company make Reserved Instance purchases and capitalize them.
...
- [x] Contain redundant connectivity
- [x] Contain redundant networking
- [x] Contain physically separated data centers
...
- [ ] There are more Availability Zones than edge locations.
- [x] There are more edge locations than Regions.
- [x] There are more Availability Zones than Regions.
...
- [x] A specific geographic location designed to provide high availability to a certain area.
...
- [x] You can stop guessing capacity.
- [x] You can go global in minutes.
- [ ] You can trade variable expense for capital expense.
- [x] You can increase speed and agility.
...
- [x] There are more edge locations than Availability Zones.
- [ ] There are more Availability Zones than edge locations.
...
- [x] The HR Assistant inherits the permissions of the 'HumanResources' group.
- [x] The HR Assistant becomes an IAM member of the company’s Human Resources department.
...
- [x] As an AWS customer, you are responsible for the security IN the Cloud.
- [x] AWS is responsible for the security OF the Cloud.
...
- [x] Controlling access to the database
...
- [x] Create an IAM role and have the application assume the role.
...
- [x] AWS is responsible for ensuring malicious traffic does not impair the network hardware.
- [x] The customer is responsible for ensuring unwanted traffic does not reach the EC2 instance.
- [x] The customer is responsible for ensuring malicious traffic does not reach the EC2 instance.
...
- [x] Programmatic access via the command line
...
- [x] By using AWS' network of edge locations to upload to a location closest to you before taking the most optimal path within AWS' network
...
- [x] It supplies various configurations of CPU, memory, storage, and network capacity. You can use a preconfigured template called an Amazon Machine Image (AMI) to launch your instance.
- [x] It provides scalable computing capacity in the AWS cloud.
- [ ] It is used to launch up to 5 servers.
- [x] It provides virtual computing environments.
...
- [x] No upfront payments required
- [ ] Guaranteed cost
- [x] Unpredictable workloads that cannot be interrupted
...
- [x] Redirecting focus to innovation and invention
- [x] Reducing procurement complexity
- [ ] Spending more money in the long term
- [x] Enabling the full elasticity of business operations
...
- [x] Contact AWS and request a service limit increase.
...
- [x] Just start deploying the applications to the new Regions.
...
- [x] Number of Edge Locations > Number of Availability Zones > Number of Regions
...
- [x] New security groups allow only outbound traffic and block all incoming traffic.
...
- [x] Patching and maintenance of OS and applications
...
- [ ] User password rules
- [x] Network patching
- [x] Physically securing compute resources
...
- [x] Patching the operating system
- [x] Patching the applications
...
- [x] Assistance with protection from common DDoS attacks
...
- [x] It supports several popular programming languages for writing application code.
- [ ] It triggers charges whether your code is running or not.
- [x] It lets you run code without provisioning or managing servers.
- [x] It is a serverless computing platform.
...
- [x] It can deliver up to five times the throughput of MySQL.
- [ ] It is compatible with MariaDB.
- [ ] It is compatible with Oracle.
- [x] It is a Relational Database Service (RDS) database engine developed by Amazon.
...
- [x] With CloudTrail, you can create a trail that either applies to one Region or to all Regions.
- [x] CloudTrail delivers log files within 15 minutes of account activity.
- [x] Log files are encrypted
...
- [x] It is designed for storing petabytes of data.
- [x] It is a data warehouse service.
...
- [x] The Dev team will be billed for 2 instances at On-Demand prices and 2 instances at the Reserved Instance price.
...
- [x] Some AWS services come with short-term free trial offers.
- [ ] Amazon S3 storage of up to 5 GB is always free.
- [x] Some AWS services are free for the first 12 months following the initial sign-up date to AWS.
